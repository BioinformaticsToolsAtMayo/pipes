...
/**
 *  Tab2JSONPipe takes in it's constructor a String[] describing each of the columns
 * in a tab delimited file (i.e. the metadata) and it converts these columns to JSON,
...
//    public static String equal = "equal";
    ...
    public Tab2JSONPipe(String[] encoding){
        getMeta(encoding);
    }
